...
#define CONFIGURE_ARGS " '--enable-cassert' '--enable-debug'"
...
#define PG_VERSION_STR "PostgreSQL 13devel on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.3.0-10ubuntu2) 9.3.0, 64-bit"
