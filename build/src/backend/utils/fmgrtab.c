...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 8190, 1, true, false, "network_sortsupport", network_sortsupport },
  { 8295, 2, true, false, "xid8lt", xid8lt },
  { 8296, 2, true, false, "xid8gt", xid8gt },
  { 8297, 2, true, false, "xid8le", xid8le },
  { 8298, 2, true, false, "xid8ge", xid8ge },
  { 8387, 4, true, false, "matchingsel", matchingsel },
  { 8388, 5, true, false, "matchingjoinsel", matchingjoinsel },
  { 8389, 1, true, false, "numeric_min_scale", numeric_min_scale },
  { 8390, 1, true, false, "numeric_trim_scale", numeric_trim_scale },
  { 8463, 2, true, false, "int4gcd", int4gcd },
  { 8464, 2, true, false, "int8gcd", int8gcd },
  { 8465, 2, true, false, "int4lcm", int4lcm },
  { 8466, 2, true, false, "int8lcm", int8lcm },
  { 8467, 2, true, false, "numeric_gcd", numeric_gcd },
  { 8468, 2, true, false, "numeric_lcm", numeric_lcm },
  { 8505, 1, true, false, "btvarstrequalimage", btvarstrequalimage },
  { 8506, 1, true, false, "btequalimage", btequalimage },
  { 8613, 0, true, true, "pg_get_shmem_allocations", pg_get_shmem_allocations },
  { 8872, 1, true, false, "pg_stat_get_ins_since_vacuum", pg_stat_get_ins_since_vacuum },
  { 8945, 5, false, false, "jsonb_set_lax", jsonb_set_lax },
  { 9247, 1, true, false, "pg_snapshot_in", pg_snapshot_in },
  { 9248, 1, true, false, "pg_snapshot_out", pg_snapshot_out },
  { 9249, 1, true, false, "pg_snapshot_recv", pg_snapshot_recv },
  { 9250, 1, true, false, "pg_snapshot_send", pg_snapshot_send },
  { 9251, 0, true, false, "pg_current_xact_id", pg_current_xact_id },
  { 9252, 0, true, false, "pg_current_xact_id_if_assigned", pg_current_xact_id_if_assigned },
  { 9253, 0, true, false, "pg_current_snapshot", pg_current_snapshot },
  { 9254, 1, true, false, "pg_snapshot_xmin", pg_snapshot_xmin },
  { 9255, 1, true, false, "pg_snapshot_xmax", pg_snapshot_xmax },
  { 9256, 1, true, true, "pg_snapshot_xip", pg_snapshot_xip },
  { 9257, 2, true, false, "pg_visible_in_snapshot", pg_visible_in_snapshot },
  { 9258, 1, true, false, "pg_xact_status", pg_xact_status },
  { 9420, 1, true, false, "xid8in", xid8in },
  { 9421, 1, true, false, "xid8toxid", xid8toxid },
  { 9554, 1, true, false, "xid8out", xid8out },
  { 9555, 1, true, false, "xid8recv", xid8recv },
  { 9556, 1, true, false, "xid8send", xid8send },
  { 9557, 2, true, false, "xid8eq", xid8eq },
  { 9558, 2, true, false, "xid8ne", xid8ne },
  { 9559, 1, true, false, "anycompatible_in", anycompatible_in },
  { 9560, 1, true, false, "anycompatible_out", anycompatible_out },
  { 9561, 1, true, false, "anycompatiblearray_in", anycompatiblearray_in },
  { 9562, 1, true, false, "anycompatiblearray_out", anycompatiblearray_out },
  { 9563, 1, true, false, "anycompatiblearray_recv", anycompatiblearray_recv },
  { 9564, 1, true, false, "anycompatiblearray_send", anycompatiblearray_send },
  { 9565, 1, true, false, "anycompatiblenonarray_in", anycompatiblenonarray_in },
  { 9566, 1, true, false, "anycompatiblenonarray_out", anycompatiblenonarray_out },
  { 9567, 3, true, false, "anycompatiblerange_in", anycompatiblerange_in },
  { 9568, 1, true, false, "anycompatiblerange_out", anycompatiblerange_out },
  { 9912, 2, true, false, "xid8cmp", xid8cmp },
  { 9991, 1, true, false, "tsm_system_handler", tsm_system_handler },
  { 9992, 1, true, false, "tsm_system_handler", tsm_system_handler }
};

const int fmgr_nbuiltins = (sizeof(fmgr_builtins) / sizeof(FmgrBuiltin));

const Oid fmgr_last_builtin_oid = 9992;

const uint16 fmgr_builtin_oid_index[9993] = {
